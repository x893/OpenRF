 ...
 * \return 0 if successful, >=1 if not.
 */
void WriteCharSPIMultiple ( U8 reg /*! Register to write */ ,
						U8 count /*! Number of bytes to write */,
						U8* buffer /*! Pointer to buffer containing data to write */) reentrant;
/*! \details Read multiple bytes from the SPI port
 *
 */
void ReadCharSPIMultiple(U8 address/*! Address to read */,
						U8 count/*! Number of bytes to read from SPI port */,
						U8 *receiveBuffer /*! Pointer to buffer to hold received bytes */) reentrant;
 ...
 * \return 0 if successful, >=1 if not.
 */
void WriteCharSPIMultiple2 ( U8 reg /*! Register to write */ ,
						U8 count /*! Number of bytes to write */,
						U8* buffer /*! Pointer to buffer containing data to write */) reentrant;
/*! \details Read multiple bytes from the SPI2 port
 *
 */
void ReadCharSPIMultiple2(U8 address/*! Address to read */,
						U8 count /*! Number of bytes to read from SPI port */,
						U8 *receiveBuffer /*! Pointer to buffer to hold received bytes */) reentrant;
